...
MODULE kinds
  ...
  CONTAINS
    ...
    SUBROUTINE eps_writetofile_proj_binary(namein, nw, nks, wgrid, nbnd, proj_epsr, proj_epsi, k_proj, k_proj_intra, array_etrans)
      USE kinds,  ONLY : DP
      ...
      CHARACTER(256)    :: str
      INTEGER           :: iwprojreal, iwprojimag, ikproj, ikprojintra, ietrans, dir, iw, ik
      ...
      do dir = 1, 3
        ...
        IF (PRESENT(k_proj_intra)) THEN
          ...
          WRITE(ikproj) nbnd
          WRITE(ikproj) nks
          IF (PRESENT(array_etrans)) WRITE(ikproj) array_etrans        
  ...
  !
      ...
      IF(ionode) WRITE(stdout,'(10x, a, I5)') "intrasmear=",  intrasmear
                  ...
                  DO iband1 = nbndmin,nbndmax
                      ...
                      IF ( focc(iband1,ik) >= 0.5d-4*full_occ ) THEN
                          ...
                          DO iw = 1, nw
                              ...
                              proj_epsi(:,iw,iband1,iband2) = epsi(:,iw)
      ...
      IF ( ionode ) THEN
          ...
          IF (metalcalc) THEN
            CALL eps_writetofile_proj_binary('proj', nw, nks, wgrid, nbnd, proj_epsr, proj_epsi, k_proj, k_proj_intra, array_etrans)
          ELSE
            CALL eps_writetofile_proj_binary('proj', nw, nks, wgrid, nbnd, proj_epsr, proj_epsi, k_proj, array_etrans)
          ENDIF  
          !
      ENDIF
